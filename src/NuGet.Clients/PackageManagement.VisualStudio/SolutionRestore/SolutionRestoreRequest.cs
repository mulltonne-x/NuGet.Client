...
namespace NuGet.PackageManagement.VisualStudio
{
    ...
    public sealed class SolutionRestoreRequest
    {
        ...
        /// <summary>
        /// Should use modal progress dialog to block VS UI while running restore operation.
        /// </summary>
        public bool UseModalProgressUI { get; }
            ...
            RestoreOperationSource restoreSource)
        {
            ...
            UseModalProgressUI = useModalProgressUI;
